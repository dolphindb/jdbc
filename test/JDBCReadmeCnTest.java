...
public class JDBCReadmeCnTest
{
    ...
    static String PORT = String.valueOf(JDBCTestUtil.PORT);
    private static final String JDBC_DRIVER = "com.dolphindb.jdbc.Driver";
    // Connect to DolphinDB server
    private static final String url1 = "jdbc:dolphindb://"+HOST+":"+PORT;
    // Connect to DolphinDB Database
    private static final String url2 = "jdbc:dolphindb://"+HOST+":"+PORT+"?databasePath=dfs://valuedb&partitionType=VALUE&partitionScheme=2000.01M..2019.05M";
    ...
    public void test()
    {
        ...
        String in_memory_database=JDBCTestUtil.WORK_DIR;// Local database path
