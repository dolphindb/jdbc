 ...
 * In the JDBC interface, you can use the `excute` method to execute all DolphinDB Sql statements. For details, see [DolphinDB SQL](http://www.dolphindb.com/help/Chapter8SQLStatements.html) 
