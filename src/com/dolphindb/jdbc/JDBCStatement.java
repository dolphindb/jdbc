...
public class JDBCStatement implements Statement {
    ...
    public long executeLargeUpdate(String sql, String[] columnNames) throws SQLException {
        System.out.println("JDBCStatement.executeLargeUpdate");
        return 0;
    }
    ...
    public long[] executeLargeBatch() throws SQLException {
        System.out.println("JDBCStatement.executeLargeBatch");
        return new long[0];
    }

    @Override
    public long getLargeMaxRows() throws SQLException {
        System.out.println("JDBCStatement.getLargeMaxRows");
        return 0;
    }

    @Override
    public void setLargeMaxRows(long max) throws SQLException {
        System.out.println("JDBCStatement.setLargeMaxRows");
    }

    @Override
    public long getLargeUpdateCount() throws SQLException {
        System.out.println("JDBCStatement.getLargeUpdateCount");
        return 0;
    }
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ...
        Entity entity;
        System.out.println("JDBCStatement.executeQuery.dml : " + dml);
        switch (dml){
            ...
            case Utils.DML_SELECT:
                try {
                    ...
                    System.out.println("JDBCStatement.executeQuery.entity : " + entity);
                    if(entity instanceof BasicTable){
                        resultSet = new JDBCResultSet(connection, this, entity, sql);
                        System.out.println("JDBCStatement.executeQuery.entity.rows : " + entity.rows());
                        return resultSet;
                    }else{
                        throw new SQLException("the given SQL statement produces anything other than a single ResultSet object");
                    }
    ...
    public int getMaxFieldSize() throws SQLException {
        System.out.println("JDBCStatement.getMaxFieldSize");
        return 0;
    ...
    public void setMaxFieldSize(int maxFieldSize) throws SQLException {
        System.out.println("JDBCStatement.setMaxFieldSize");
        return ;
    }

    @Override
    public int getMaxRows() throws SQLException {
        System.out.println("JDBCStatement.getMaxRows");
        return 0;
    }
    ...
    public void setQueryTimeout(int queryTimeout) throws SQLException {
        System.out.println("JDBCStatement.setQueryTimeout : " + queryTimeout);
        timeout = queryTimeout * 1000L;
    }

    @Override
    public void cancel() throws SQLException {
        System.out.println("JDBCStatement.cancel");
        return ;
    }

    @Override
    public SQLWarning getWarnings() throws SQLException {
        System.out.println("JDBCStatement.getWarnings");
