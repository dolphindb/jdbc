...
public class Driver implements java.sql.Driver {
    ...
    public static Map<String, Object> parseProp(String url, Properties prop) throws SQLException {
        Map<String, Object> allProp = new HashMap<>();
        ...
        if (url.length() == 0 || url.equals("?")){
            ...
            allProp.put("old_url", old_url);
            allProp.put("prop", prop);
            return allProp;
        } else {
